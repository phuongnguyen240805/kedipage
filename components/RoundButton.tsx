	...
	return (
		<Link
			...
			<Rounded
				...
				<div
					className={`p-[10px] rounded-full scale-[0.3] mr-[10px] group-hover:scale-[0.9] transition-all z-10 transform duration-&lsqb;0.3s&rsqb; ease-&lsqb;.215,.61,.355,1&rsqb; ${className}`}>
					<ArrowUpRight
						strokeWidth={1.5}
						size={30}
