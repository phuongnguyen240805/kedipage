export const affiliateTexts = {
  ...
  commission: {
    ...
    notes: {
      ...
      note3:
        'Làm việc ở bất kỳ đâu, bất kỳ lúc nào, phù hợp cho mọi đối tượng từ freelancer đến dân văn phòng.',
      note4:
        'Được lựa chọn nhiều sản phẩm phù hợp với nhu cầu và đối tượng khách hàng của anh chị.',
    },
  },
  commissionPolicy: {
    ...
    table: {
      headers: ['Bậc', 'Tỷ lệ hoa hồng', 'Điều kiện nhận'],
      rows: [
        ['Bậc 1', '5%', 'Mặc định khi tham gia hợp tác'],
        ['Bậc 2', '8%', 'Khi tổng hoa hồng tích lũy (TLHH) đạt 20 triệu'],
        ['Bậc 3', '10%', 'Khi tổng hoa hồng tích lũy (TLHH) đạt 50 triệu'],
        [
          'Bậc cao hơn',
          '???',
  ...
  supportDeal: {
    ...
    description:
      'Anh chị chỉ cần giới thiệu khách, còn lại từ deal đến dịch vụ đều có tụi em lo. NHƯNG NẾU ANH CHỊ HỖ TRỢ DEAL/ĐỒNG HÀNH CÙNG KHÁCH và được',
    bonus:
      'Ví dụ: SaaS E-learning: Hoa hồng 15% ngay từ đầu. 10% HOA HỒNG, từ các khoản hỗ trợ deal khách hàng đến cho anh chị!',
  },
  exampleSection: {
    badge: 'VÍ DỤ',
    caseIntro:
    ...
    options: [
      ...
      {
        title: 'Nếu hỗ trợ deal, tư vấn, follow-up khách hàng...',
        description:
          '➜ Anh/chị nhận hoa hồng theo bậc (10% - hơn) và thêm hoa hồng hỗ trợ từ deal',
      },
    ],
  },
};
