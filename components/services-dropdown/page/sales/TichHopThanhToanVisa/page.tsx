...
const ClientTichHopThanhToanVisa = dynamic(
...
// 🚀 Component chính cho trang Tích Hợp Thanh Toán Visa
export default function PageTichHopThanhToanVisa() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      {/* Header */}
      <h1 className="text-3xl font-bold text-center text-gray-800">
        Tích Hợp Thanh Toán Visa
      </h1>
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các giải pháp tích hợp thanh toán Visa chuyên nghiệp, thiết kế
        tinh gọn, hiện đại và tối ưu chuyển đổi.
      </p>

      {/* Nội dung lazy load */}
      <LazySection>
        <ClientTichHopThanhToanVisa />
      </LazySection>
    </div>
  );
}
