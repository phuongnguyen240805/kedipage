...
const ClientPhanMemQuanLyBanHang = dynamic(
...
// 🚀 Component chính cho trang Phần Mềm Quản Lý Bán Hàng
export default function PagePhanMemQuanLyBanHang() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      ...
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các giải pháp phần mềm quản lý bán hàng chuyên nghiệp, thiết kế
        tinh gọn, hiện đại và tối ưu chuyển đổi.
      </p>

      {/* Nội dung lazy load */}
      <LazySection>
        <ClientPhanMemQuanLyBanHang />
      </LazySection>
    </div>
  );
}
