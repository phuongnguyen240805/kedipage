...
const ClientThietKeWebsiteBanHang = dynamic(
  () => import('./client'), // đường dẫn tới file ClientThietKeWebsiteBanHang.tsx hoặc client.tsx
  {
    loading: () => (
...
export default function PageThietKeWebsiteBanHang() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      ...
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các mẫu website chuyên nghiệp, thiết kế tinh gọn, hiện đại và
        tối ưu chuyển đổi.
      </p>

      {/* Nội dung lazy load */}
      <LazySection>
        <ClientThietKeWebsiteBanHang />
      </LazySection>
    </div>
  );
}
