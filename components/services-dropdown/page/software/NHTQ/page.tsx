...
const ClientNHTQ = dynamic(
  () => import('./client'), // đường dẫn tới file ClientNHTQ.tsx hoặc client.tsx
  {
    loading: () => (
...
// 🚀 Component chính cho trang NHTQ
export default function PageNHTQ() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      {/* Header */}
      <h1 className="text-3xl font-bold text-center text-gray-800">NHTQ</h1>
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các phần mềm NHTQ chuyên nghiệp, thiết kế tinh gọn, hiện đại và
        tối ưu chuyển đổi.
      </p>
