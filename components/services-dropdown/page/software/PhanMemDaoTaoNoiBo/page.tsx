...
const ClientPhanMemDaoTaoNoiBo = dynamic(
...
// 🚀 Component chính cho trang Phần Mềm Đào Tạo Nội Bộ
export default function PagePhanMemDaoTaoNoiBo() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      {/* Header */}
      <h1 className="text-3xl font-bold text-center text-gray-800">
        Phần Mềm Đào Tạo Nội Bộ
      </h1>
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các phần mềm đào tạo nội bộ chuyên nghiệp, thiết kế tinh gọn,
        hiện đại và tối ưu chuyển đổi.
      </p>

      {/* Nội dung lazy load */}
      <LazySection>
        <ClientPhanMemDaoTaoNoiBo />
      </LazySection>
    </div>
  );
}
