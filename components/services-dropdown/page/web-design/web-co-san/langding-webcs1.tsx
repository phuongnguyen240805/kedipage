...
export default function Langdingwebcs1() {
      ...
      <div className="relative z-10 flex flex-col items-center max-w-6xl w-full pt-10 pb-20">
        ...
        <FadeIn delay={0.2}>
          <h1 className="text-4xl md:text-6xl font-black text-white mb-6 leading-[1.1] tracking-tighter">
            ...
            mẫu website <br />
            <span className="italic font-serif font-light opacity-90 text-3xl md:text-5xl">
              chuyên nghiệp
            </span>
            <span className="ml-4 bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">
              Đa lĩnh vực
            </span>
          </h1>
        </FadeIn>
