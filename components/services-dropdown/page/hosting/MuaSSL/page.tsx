...
// 🚀 Component chính cho trang MuaSSL
export default function PageMuaSSL() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      {/* Header */}
      <h1 className="text-3xl font-bold text-center text-gray-800">MuaSSL</h1>
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các giải pháp MuaSSL chuyên nghiệp, thiết kế tinh gọn, hiện đại
