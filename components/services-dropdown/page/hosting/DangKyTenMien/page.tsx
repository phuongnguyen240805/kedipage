...
const ClientDangKyTenMien = dynamic(
  () => import('./client'), // đường dẫn tới file ClientDangKyTenMien.tsx hoặc client.tsx
  {
    loading: () => (
...
export default function PageDangKyTenMien() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      ...
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các giải pháp Đăng Ký Tên Miền chuyên nghiệp, thiết kế tinh
