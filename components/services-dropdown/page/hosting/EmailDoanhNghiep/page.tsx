...
const ClientEmailDoanhNghiep = dynamic(
  () => import('./client'), // đường dẫn tới file ClientEmailDoanhNghiep.tsx hoặc client.tsx
  {
    loading: () => (
...
// 🚀 Component chính cho trang Email Doanh Nghiệp
export default function PageEmailDoanhNghiep() {
  return (
    <div className="flex flex-col gap-6 px-6 py-10">
      ...
      <p className="text-center text-gray-500 max-w-2xl mx-auto">
        Khám phá các giải pháp Email Doanh Nghiệp chuyên nghiệp, thiết kế tinh
        gọn, hiện đại và tối ưu chuyển đổi.
      </p>

      {/* Nội dung lazy load */}
      <LazySection>
        <ClientEmailDoanhNghiep />
      </LazySection>
    </div>
  );
}
