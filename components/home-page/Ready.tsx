...
export default function Ready() {
  ...
  // Giới hạn di chuyển để mắt không bay quá xa
  const y = useTransform(scrollYProgress, [0, 1], [0, -300]); // giảm từ -700 → -300

  return (
    <section
      ref={container}
      className="w-full relative z-30 min-h-screen bg-about padding-y rounded-t-[20px] mt-[-20px]"
    >
      <div className="w-full h-full flex justify-center gap-[50px] items-center flex-col">
        {/* Tiêu đề chính */}
        <h1 className="text-[290px] leading-[230px] lg:text-[220px] lg:leading-[170px] md:text-[180px] md:leading-[140px] sm:text-[120px] sm:leading-[90px] xm:text-[56px] xm:leading-[48px] tracking-[-2.5px] text-center font-bold font-FoundersGrotesk text-secondry uppercase pointer-events-none">
