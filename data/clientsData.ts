...
export const clients: ClientData[] = [
...

  {
    ...
    clientName: 'Anh Đoàn Quốc Châu',
    clientRole: 'Giám đốc sáng tạo',
    clientDescription: `Là một trong những người quản lý chuỗi hệ thống rạp chiếu phim của Cinestar...`,
    companySummary: `Cinestar là một trong số những rạp chiếu phim hàng đầu tại Việt Nam...`,
    youtubeVideoId: 'czmj2NNaPJI',
    leftImage:
      'https://mona.media/wp-content/uploads/2024/01/Cinestar1-600x401.png',
    rightImage:
      'https://mona.media/wp-content/uploads/2024/01/Cinestar-3-e1706681490595-576x600.png',
    buttons: [
...

  {
    id: 'vinai',
    layout: 'layout2',
    clientLogo: 'https://mona.media/wp-content/uploads/2023/12/logo_vinai.png',
    ...
    youtubeVideoId: 'czmj2NNaPJI',
    leftImage:
      'https://mona.media/wp-content/uploads/2024/01/Vin-3-600x401.png',
    rightImage:
      'https://mona.media/wp-content/uploads/2024/01/Vin-Ai-600x401.png',
    buttons: [{ label: 'Thiết kế website', variant: 'outline' }],
    title: 'Dự án VinAI',
  },
...

  {
    ...
    youtubeVideoId: 'czmj2NNaPJI',
    leftImage:
      'https://mona.media/wp-content/uploads/2024/01/Wolfoo2-600x401.png',
    rightImage: 'https://mona.media/wp-content/uploads/2024/01/Wolfoo-1.png',
    buttons: [
      { label: 'Chi tiết dự án' },
      { label: 'Thiết kế website', variant: 'outline' },
    ],
    title:
      'Dự án thiết kế website trong lĩnh vực sản xuất nội dung, phim hoạt hình',
  },
...

  {
    ...
    youtubeVideoId: 'czmj2NNaPJI',
    leftImage:
      'https://mona.media/wp-content/uploads/2025/03/vietpassion-2-600x401.png',
    rightImage:
      'https://mona.media/wp-content/uploads/2025/03/vietpassion-1-600x401.png',
    buttons: [{ label: 'Thiết kế website', variant: 'outline' }],
    title: 'Dự án Vietpassion',
  },
...

  {
    ...
    rightImage: 'https://mona.media/wp-content/uploads/2024/10/Phai.jpg',
    buttons: [{ label: 'Thiết kế website', variant: 'outline' }],
  },
  ...
  // -----------------------------------------------------> 6 <--------------------------------------------------------
  {
    ...
    layout: 'layout2',
    clientLogo:
      'https://mona.media/wp-content/uploads/2024/04/Logo-1-1920x613.jpg',
    clientName: 'Trung Thành',
    clientRole: 'Founder LALUZ PARFUMS',
    clientDescription:
    ...
    rightImage:
      'https://mona.media/wp-content/uploads/2024/04/Laluz1-600x401.jpg',
    buttons: [
      { label: 'Thiết kế website', variant: 'outline' },
      { label: 'SEO', variant: 'outline' },
      { label: 'Hosting', variant: 'outline' },
    ],
    title: 'Dự án Laluz',
  },
];
