...
const getComponentBySlug = (slug: string) => {
  const componentPaths: Record<string, () => Promise<any>> = {
    ...
    "kedi-os": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-os/page"),
    "kedi-crm": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-crm/page"),
    "kedi-commerce": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-commerce/page"),
    "kedi-agents": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-agents/page"),
    "kedi-outreach": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-outreach/page"),
    "kedi-profiles": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-profiles/page"),
    "kedi-ai-flow": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-ai-flow/page"),
    "kedi-video": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-video/page"),
    "kedi-pod": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-pod/page"),
    "kedi-funnel": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-funnel/page"),
    "kedi-seo": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-seo/page"),
    "kedi-ads": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-ads/page"),
    "kedi-analytics": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-analytics/page"),
    "kedi-automate": () =>
      import("@/components/services-dropdown/page/software/KediProduct/kedi-automate/page"),
